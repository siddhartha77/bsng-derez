...
#define	kFileNum	129
#define kFileDeRezApplicaiton 1

/* Custom errors */
#define kErrStringListID    300
#define kNotAPPLErr         1
#define kMoreThanOneErr     2
#define kCreatecicnErr      3
#define kResourceForkErr    4
#define kOutputErr          5
#define kOutputExistsErr    6
...
/* Output filenames */
#define kOutputFilenamesStringListID    400
#define kOutputFilenameHeader           1
#define kOutputFilenameRez              2
